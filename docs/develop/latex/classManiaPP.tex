...
\item[\hyperlink{todo__todo000004}{Todo}]Insert map into database if needed. \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000003}{Todo}]Insert player into database if needed. \end{DoxyRefDesc}
