...
\hline
\end{DoxyParams}
\hypertarget{classVersionCompare_af38a74d5e52e5f862c9d3c0f3a96cb6b}{\index{Version\-Compare@{Version\-Compare}!Not\-Older\-Than@{Not\-Older\-Than}}
\index{Not\-Older\-Than@{Not\-Older\-Than}!VersionCompare@{Version\-Compare}}
\subsubsection[{Not\-Older\-Than}]{\setlength{\rightskip}{0pt plus 5cm}static bool Version\-Compare\-::\-Not\-Older\-Than (
\begin{DoxyParamCaption}
\item[{const std\-::string \&}]{base, }
\item[{const std\-::string \&}]{comp}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{classVersionCompare_af38a74d5e52e5f862c9d3c0f3a96cb6b}
Compares two string versions.


\begin{DoxyParams}{Parameters}
{\em base} & Base string version. \\
\hline
{\em comp} & String version to compare. \\
\hline
\end{DoxyParams}
...
\item 
/home/travis/build/\-The\-Maximum/mania-\/pp/src/\-Utils/Version\-Compare.\-h\end{DoxyCompactItemize}
